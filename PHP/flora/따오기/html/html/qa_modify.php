...
?>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="690">
				...
				<tr>
					...
					<td width="586">
						&nbsp;&nbsp;<input type="text" name="name" value="<?=$row[name39]?>" size="15" class="cmfont1"><br>
					</td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
				<tr><td colspan="2" background="images/ln1.gif"></td></tr>
				...
				<tr>
					...
					<td width="586">
						&nbsp;&nbsp;<input type="password" name="passwd" value="<?=$row[passwd39]?>" size="10" class="cmfont1"><br>
					</td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
				<tr><td colspan="2" background="images/ln1.gif"></td></tr>
				...
				<tr>
					...
					<td width="586">
						&nbsp;&nbsp;<input type="text" name="email" value="<?=$row[email39]?>" size="30" class="cmfont1"><br>
					</td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
				<tr><td colspan="2" background="images/ln1.gif"></td></tr>
