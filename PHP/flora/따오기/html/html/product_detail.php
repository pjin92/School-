						...
						<table border="0" cellpadding="0" cellspacing="1" width="315" height="315" bgcolor="D4D0C8">
							<tr>
								<td bgcolor="white" align="center">
									<img src="product/<?=$row[image2]?>" height="315" border="0" align="absmiddle" ONCLICK="Zoomimage('<?=$row[no39]?>')" STYLE="cursor:hand">
								</td>
							</tr>
						</table>
					</td>
						...
						<table border="0" cellpadding="0" cellspacing="0" width="370" class="cmfont">
							...
							<tr>
								...
								<td style="padding-left:10px">
									<font color="282828"><?=$name39?></font><br>
<?
				if($row[icon_new39]==1)
...
?>
							...
							<tr>
								...
								<td width="1" bgcolor="E8E7EA"></td>
								<td style="padding-left:10px"><font color="0288DD"><b><?=$discount?></b></font>
								</td>
							</tr>
							<tr><td colspan="3" bgcolor="E8E7EA"></td></tr>
							<!-- 옵션 -->
...
<?
	$query = "select * from opts where opt_no39=$row[opt1]";
	$result=mysql_query($query);
...
<?
	$query = "select * from opts where opt_no39=$row[opt2]";
	$result=mysql_query($query);
	$count=mysql_num_rows($result);
	for($i=0;$i<$count;$i++)
	{
