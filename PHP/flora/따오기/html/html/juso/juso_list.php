...
<?
if(!$text1)
	$query="select * from juso order by name39;";
else
	$query="select * from juso where name39 like '$text1%' order by name39;";
	...
	for($i=0;$i<$page_last;$i++)
	{
		...
		echo("<tr bgcolor='lightyellow'>
				<td width='80' align='center'><a href='juso_edit.php?no=$row[no39]'> $row[name39]</a></td>
				<td width='100'  align='center'>$tel</td>
				<td width='50'  align='center'>$sm</td>
				<td width='70'  align='center'>$row[birthday39]</td>
				<td width='250'  align='center'>$row[juso39]</td>
				<td align='center' width='50'>
				<a href='juso_delete.php?no=$row[no39]' onClick='javascript:return confirm(\"삭제할까요?\");'>삭제</a>
				</td>
			 </tr>");
	}
?>
...
<?
	...
	{
		$tmp = $page_s;
		echo("<a href='juso_list.php?page=$tmp&text1=$text1'><img src='images/i_prev.gif' align='absmiddle' border='0'></a>&nbsp");
	}
