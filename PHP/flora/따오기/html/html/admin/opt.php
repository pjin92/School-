...
<?
	...
	$query="select * from opt order by no39;";
...
<?
	...
	for($i=0;$i<$page_last;$i++)
	{
		...
		echo("<tr bgcolor='#F2F2F2' height='20'>	
				...
				<td width='200' align='left'>&nbsp$row[name39]</td>
				<td width='100' align='center'>
					<a href='opt_edit.php?no1=$row[no39]'>수정</a>/
					<a href='opt_delete.php?no1=$row[no39]' onclick='javascript:return confirm(\"삭제할까요 ?\");'>삭제</a>
				</td>
				<td width='100' align='center'><a href='opts.php?no1=$no'>소옵션편집</a></td>
			</tr>");
	}
?>
</table>
<?
	...
	{
		$tmp = $page_s;
		echo("<a href='opt.php?page=$tmp'><img src='images/i_prev.gif' align='absmiddle' border='0'></a>&nbsp");
	}
	for($i=$page_s+1; $i<=$page_e; $i++)
	{
		if($page ==$i)
			...
			echo("<a href='opt.php?page=$i'>[$i]</a>&nbsp");
	}
	if ($block < $blocks)
	{
		$tmp = $page_e+1;
		echo("&nbsp<a href='opt.php?page=$tmp'><img src='images/i_next.gif' align='absmiddle' border='0'></a>");
	}
	echo("</td>
		</tr>
		</table>");
