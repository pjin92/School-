...
<?
	$query = "select  *  from   member   where no39 = $cookie_no;";
								...
								<td align="center">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										<tr>
											...
											<td>
												<input type="text" name="name" maxlength="10" value="<?=$row[name39]?>" size="20" class="cmfont1">
											</td>
										</tr>
										<tr>
											<td width="127" height="30">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="635" class="cmfont">
										...
										<tr>
											...
											<td>
												...
												<input type="text" name='juso' size="50" maxlength="200" value="<?=$row[juso39]?>" class="cmfont1"><br>
											</td>
										</tr>
										<tr>
											<td width="127" height="50">
											...
											<td>
												<input type="text" name='email' size="50" maxlength="50" value="<?=$row[email39]?>" class="cmfont1">
											</td>
										</tr>
										<tr><td colspan="2" height="10"></td></tr>
										<tr><td colspan="2" bgcolor="E6DDD5"></td></tr>
