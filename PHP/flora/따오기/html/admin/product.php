...
<?
  ...
  for($i=0;$i<$page_last;$i++)
  {
	...
	echo("<tr bgcolor='#F2F2F2' height='23'>
			...
			<a href='product_edit.php?no=$row[no59]&sel1=$sel1&sel2=$sel2&sel3=$sel3&sel4=$sel4&text1=$text1&page=$page'>수정</a>/
			<a href='product_delete.php?no=$row[no59]&sel1=$sel1&sel2=$sel2&sel3=$sel3&sel4=$sel4&text1=$text1&page=$page' onclick='javascript:return confirm(\"삭제할까요 ?\");'>삭제</a>
		</td>
		  </tr>");
  }
  ?>
