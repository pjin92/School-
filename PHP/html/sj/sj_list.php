...
<table width="400" border="1" cellpadding="1" cellspacing="0">
  ...
  <?
  if (!$text1)
  $query="select * from sj order by name68;";
  else
  $query="select * from sj where name68 like '$text1%' order by name68;";
  ...
  echo("<tr bgcolor='lightyellow'>
    <td width='100'>&nbsp
	<a href='sj_edit.php?no=$row[no68]'>$row[name68]</a>
	</td>
    <td width='50'  align='right'>$row[kor68]&nbsp</td>
    <td width='50'  align='right'>$row[eng68]&nbsp</td>
    <td width='50'  align='right'>$row[mat68]&nbsp</td>
    <td width='50'  align='right'>$row[hap68]&nbsp</td>
    <td width='50'  align='right'>$avg &nbsp</td>
	<td align='center'>
	<a href='sj_delete.php?no=$row[no68]'
