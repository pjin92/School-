...
<?
	include "common.php";
	$count=$count+1;
	$query="update qa set count68='$count' where no68=$no;";
...
<?
	...
	if ($row[ishtml]=="0")
		$content68=htmlspecialchars($content68);    // text 인 경우
	else
...
?>
			...
			<table border="0" cellpadding="0" cellspacing="0" width="690">
				...
				<tr>
					...
					<td width="586" class="cmfont">&nbsp;&nbsp;<?=$title68?></td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
				...
				<tr>
					...
					<td width="586" class="cmfont">&nbsp;&nbsp;<a href="mailto:<?=$row[email68]?>"><?=$row[name68]?></a></td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
				<tr><td colspan="2" background="images/ln1.gif"></td></tr>
				<tr><td colspan="2" height="2"></td></tr>
				<tr>
					...
					<td width="586" class="cmfont">&nbsp;&nbsp;<?=$row[writeday68]?></td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
				<tr><td colspan="2" background="images/ln1.gif"></td></tr>
				<tr><td colspan="2" height="2"></td></tr>
				<tr>
					...
					<td width="586" class="cmfont">&nbsp;&nbsp;<?=$row[count68]?></td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
				<tr><td colspan="2" background="images/ln1.gif"></td></tr>
				<tr><td colspan="2" height="2"></td></tr>
				<tr>
					...
					<td width="586" class="cmfont">
						<p style="padding-left:5px;padding-top:5px;padding-right:5px;padding-bottom:5px;"><?=$content68?></p>
					</td>
				</tr>
				<tr><td colspan="2" height="2"></td></tr>
			</table>
