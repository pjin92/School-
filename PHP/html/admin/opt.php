	...
	<?
	  ...
	  for($i=0;$i<$page_last;$i++)
	  {
		...
		echo("<tr bgcolor='#F2F2F2' height='23'>
				...
				<td align='center'>
				<a href='opt_edit.php?no1=$row[no68]&page=$page&sel1=$sel1&text1=$text1'>수정</a>/
				<a href='opt_delete.php?no1=$row[no68]&page=$page&sel1=$sel1&text1=$text1' onclick='javascript:return confirm(\"삭제할까요 ?\");'>삭제</a>
			</td>
			<td width='100' align='center'><a href='opts.php?no1=$row[no68]'>소옵션편집</a></td>
			  </tr>");
	 }
?>
</table>
