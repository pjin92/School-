...
<!-------------------------------------------------------------------------------------------->	
			...
			<?
				$query="select * from product where icon_new68=1 and status68=1 order by rand() limit 50";
				$num_col=5;   
				$num_row=5;
						...
						<table border='0' cellpadding='0' cellspacing='0' width='100' class='cmfont'>
							...
							<tr> 
								<td height='20' align='center'>
									<a href='product_detail.php?no=$row[no68]'><font color='444444'>$name68</font></a>&nbsp; 
